...
})({"hTuMO":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "98ec82e0c33c63c0";
"use strict";
...
},{}],"csP6f":[function(require,module,exports) {
(function(b, k) {
    k(exports);
})(this, function(b) {
    "use strict";
    var Wt = Object.defineProperty;
    var Nt = (b, k, g)=>k in b ? Wt(b, k, {
            enumerable: !0,
            configurable: !0,
            writable: !0,
            value: g
    ...
    let Ue = class {
        ...
        addToRenderTargetsStack(e) {
            ...
            let s = -1;
            if (e.target._depth) {
                for(let i = t.length - 1; i >= 0; i--)if (t[i].target.uuid === e.target.uuid) {
                    s = i + 1;
                    break;
                }
        ...
        addToRegularPlaneStack(e) {
            ...
            let s = -1;
            for(let i = t.length - 1; i >= 0; i--)if (t[i]._geometry.definition.id === e._geometry.definition.id) {
                s = i + 1;
                break;
            }
    ...
    class We {
        constructor({ alpha: e, antialias: t, premultipliedAlpha: s, depth: i, failIfMajorPerformanceCaveat: r, preserveDrawingBuffer: a, stencil: h, container: o, pixelRatio: l, renderingScale: d, production: c, onError: f, onSuccess: u, onContextLost: p, onContextRestored: m, onDisposed: w, onSceneChange: R }){
        ...
        isContextexFullyRestored() {
            ...
            if (e) for(let t = 0; t < this.planes.length; t++)if (this.planes[t]._canDraw) {
                for(let s = 0; s < this.planes[t].textures.length; s++)if (!this.planes[t].textures[s]._canDraw) {
                    e = !1;
                    break;
                }
            } else {
            ...
            if (e) for(let t = 0; t < this.shaderPasses.length; t++)if (this.shaderPasses[t]._canDraw) {
                for(let s = 0; s < this.shaderPasses[t].textures.length; s++)if (!this.shaderPasses[t].textures[s]._canDraw) {
                    e = !1;
                    break;
                }
            } else {
    ...
    class He {
        constructor({ container: e, alpha: t = !0, premultipliedAlpha: s = !1, antialias: i = !0, depth: r = !0, failIfMajorPerformanceCaveat: a = !0, preserveDrawingBuffer: h = !1, stencil: o = !1, autoResize: l = !0, autoRender: d = !0, watchScroll: c = !0, pixelRatio: f = window.devicePixelRatio || 1, renderingScale: u = 1, production: p = !1 } = {}){
    ...
    class Ge {
        constructor(e, t, s){
            ...
            if (this.renderer = e, this.gl = e.gl, this.program = t, this.uniforms = {}, s) for(const i in s){
                const r = s[i];
                this.uniforms[i] = {
                    name: r.name,
                    type: r.type,
        ...
        setUniforms() {
            if (this.uniforms) for(const e in this.uniforms){
        ...
        setUniform2iv(e) {
            e._internalFormat === "Vec2" ? this.gl.uniform2iv(e.location, [
                e.value.x,
                e.value.y
        ...
        setUniform2fv(e) {
            e._internalFormat === "Vec2" ? this.gl.uniform2fv(e.location, [
                e.value.x,
                e.value.y
        ...
        setUniform3iv(e) {
            e._internalFormat === "Vec3" ? this.gl.uniform3iv(e.location, [
                e.value.x,
                e.value.y,
                e.value.z
        ...
        setUniform3fv(e) {
            e._internalFormat === "Vec3" ? this.gl.uniform3fv(e.location, [
                e.value.x,
                e.value.y,
                e.value.z
        ...
        setUniform4iv(e) {
            e._internalFormat === "Quat" ? this.gl.uniform4iv(e.location, [
                e.value.elements[0],
                e.value.elements[1],
                e.value.elements[2],
                e.value[3]
        ...
        setUniform4fv(e) {
            e._internalFormat === "Quat" ? this.gl.uniform4fv(e.location, [
                e.value.elements[0],
                e.value.elements[1],
                e.value.elements[2],
                e.value[3]
...
`, this.gl.getShaderInfoLog(s)), z(a), g(this.type + ": Will use a default", i), this.createShader(t === this.gl.VERTEX_SHADER ? this.defaultVsCode : this.defaultFsCode, t);
    ...
    class Qe {
        ...
        bindBuffers() {
            ...
            else for(const e in this.attributes){
                if (!this.attributes[e].isActive) return;
    ...
    class N {
        ...
        getInverse() {
            const e = this.elements, t = new N, s = t.elements;
            let i = e[0], r = e[1], a = e[2], h = e[3], o = e[4], l = e[5], d = e[6], c = e[7], f = e[8], u = e[9], p = e[10], m = e[11], w = e[12], R = e[13], _ = e[14], x = e[15], y = i * l - r * o, v = i * d - a * o, P = i * c - h * o, S = r * d - a * l, D = r * c - h * l, C = a * c - h * d, E = f * R - u * w, M = f * _ - p * w, I = f * x - m * w, H = u * _ - p * R, G = u * x - m * R, j = p * x - m * _, A = y * j - v * G + P * H + S * I - D * M + C * E;
        ...
        compose(e, t, s) {
            let i = this.elements;
            const r = t.elements[0], a = t.elements[1], h = t.elements[2], o = t.elements[3], l = r + r, d = a + a, c = h + h, f = r * l, u = r * d, p = r * c, m = a * d, w = a * c, R = h * c, _ = o * l, x = o * d, y = o * c, v = s.x, P = s.y, S = s.z;
        ...
        composeFromOrigin(e, t, s, i) {
            let r = this.elements;
            const a = t.elements[0], h = t.elements[1], o = t.elements[2], l = t.elements[3], d = a + a, c = h + h, f = o + o, u = a * d, p = a * c, m = a * f, w = h * c, R = h * f, _ = o * f, x = l * d, y = l * c, v = l * f, P = s.x, S = s.y, D = s.z, C = i.x, E = i.y, M = i.z, I = (1 - (w + _)) * P, H = (p + v) * P, G = (m - y) * P, j = (p - v) * S, A = (1 - (u + _)) * S, ze = (R + x) * S, Le = (m + y) * D, ke = (R - x) * D, De = (1 - (u + w)) * D;
    ...
    class T {
        ...
        applyQuat(e) {
            const t = this._x, s = this._y, i = this._z, r = e.elements[0], a = e.elements[1], h = e.elements[2], o = e.elements[3], l = o * t + a * i - h * s, d = o * s + h * t - r * i, c = o * i + r * s - a * t, f = -r * t - a * s - h * i;
    ...
    const oe = new L, $e = new T, Ze = new N;
    class q {
        ...
        _initTexture() {
            this.gl.bindTexture(this.gl.TEXTURE_2D, this._sampler.texture), this.sourceType === "empty" && (this._globalParameters.flipY = !1, this._updateGlobalTexParameters(), this.gl.texImage2D(this.gl.TEXTURE_2D, 0, this.gl.RGBA, 1, 1, 0, this.gl.RGBA, this.gl.UNSIGNED_BYTE, new Uint8Array([
                0,
                0,
                0,
                255
...
gl.LINEAR filtering will be used instead`), this.parameters.magFilter = this.gl.LINEAR), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MAG_FILTER, this.parameters.magFilter), this._state.magFilter = this.parameters.magFilter);
        ...
        _getSizes() {
            ...
            const e = this._parent.scale ? oe.set(this._parent.scale.x, this._parent.scale.y) : oe.set(1, 1), t = this._parent._boundingRect.document.width * e.x, s = this._parent._boundingRect.document.height * e.y, i = this._size.width, r = this._size.height, a = i / r, h = t / s;
            let o = 0, l = 0;
        ...
        _updateTextureMatrix(e) {
            const t = $e.set(e.parentWidth / (e.parentWidth - e.xOffset), e.parentHeight / (e.parentHeight - e.yOffset), 1);
    ...
    class Je {
        ...
        loadImage(e, t = {}, s, i) {
            ...
            const o = new q(this.renderer, a), l = this._addElement(h, o, s, i);
        ...
        loadVideo(e, t = {}, s, i) {
            ...
            const h = new q(this.renderer, a), o = this._addElement(r, h, s, i);
    ...
    class et {
        constructor(e, t = "Mesh", { vertexShaderID: s, fragmentShaderID: i, vertexShader: r, fragmentShader: a, uniforms: h = {}, widthSegments: o = 1, heightSegments: l = 1, renderOrder: d = 0, depthTest: c = !0, cullFace: f = "back", texturesOptions: u = {}, crossOrigin: p = "anonymous" } = {}){
            ...
            this._canDraw = !1, this.renderOrder = d, this._depthTest = c, this.cullFace = f, this.cullFace !== "back" && this.cullFace !== "front" && this.cullFace !== "none" && (this.cullFace = "back"), this.textures = [], this._texturesOptions = Object.assign({
                ...
                magFilter: this.gl.LINEAR
            }, u), this.crossOrigin = p, !r && s && document.getElementById(s) && (r = document.getElementById(s).innerHTML), !a && i && document.getElementById(i) && (a = document.getElementById(i).innerHTML), this._initMesh(), o = parseInt(o), l = parseInt(l), this._geometry = new Qe(this.renderer, {
                width: o,
                height: l
...
`, r), i && i(r, a);
        ...
        _draw() {
            ...
            for(let e = 0; e < this.textures.length; e++)if (this.textures[e]._draw(), this.textures[e]._sampler.isActive && !this.textures[e]._sampler.isTextureBound) return;
    ...
    class st extends et {
        constructor(e, t, s = "DOMMesh", { widthSegments: i, heightSegments: r, renderOrder: a, depthTest: h, cullFace: o, uniforms: l, vertexShaderID: d, fragmentShaderID: c, vertexShader: f, fragmentShader: u, texturesOptions: p, crossOrigin: m } = {}){
        ...
        mouseToPlaneCoords(e) {
            const t = this.scale ? this.scale : tt.set(1, 1), s = me.set((this._boundingRect.document.width - this._boundingRect.document.width * t.x) / 2, (this._boundingRect.document.height - this._boundingRect.document.height * t.y) / 2), i = {
    ...
    class it {
        ...
        updateProjectionMatrix() {
            const e = this.width / this.height, t = this.near * Math.tan(Math.PI / 180 * .5 * this.fov), s = 2 * t, i = e * s, r = -0.5 * i, a = r + i, h = t - s, o = 2 * this.near / (a - r), l = 2 * this.near / (t - h), d = (a + r) / (a - r), c = (t + h) / (t - h), f = -(this.far + this.near) / (this.far - this.near), u = -2 * this.far * this.near / (this.far - this.near);
    ...
    const rt = new L, at = new T, nt = new T, ht = new T, ot = new T, lt = new T, dt = new T, U = new T, V = new T, _e = new se, ct = new T(.5, .5, 0), ut = new T, ft = new T, pt = new T, gt = new T, mt = new L;
    class xe extends st {
        constructor(e, t, { widthSegments: s, heightSegments: i, renderOrder: r, depthTest: a, cullFace: h, uniforms: o, vertexShaderID: l, fragmentShaderID: d, vertexShader: c, fragmentShader: f, texturesOptions: u, crossOrigin: p, alwaysDraw: m = !1, visible: w = !0, transparent: R = !1, drawCheckMargins: _ = {
            top: 0,
            right: 0,
            bottom: 0,
            left: 0
        }, autoloadSources: x = !0, watchScroll: y = !0, fov: v = 50 } = {}){
            super(e, t, "Plane", {
                widthSegments: s,
                heightSegments: i,
                renderOrder: r,
        ...
        _getNearPlaneIntersections(e, t, s) {
            ...
            if (s.length === 1) s[0] === 0 ? (t[0] = this._getIntersection(t[1], U.set(.95, 1, 0).applyMat4(i)), t.push(this._getIntersection(t[3], V.set(-1, -0.95, 0).applyMat4(i)))) : s[0] === 1 ? (t[1] = this._getIntersection(t[0], U.set(-0.95, 1, 0).applyMat4(i)), t.push(this._getIntersection(t[2], V.set(1, -0.95, 0).applyMat4(i)))) : s[0] === 2 ? (t[2] = this._getIntersection(t[3], U.set(-0.95, -1, 0).applyMat4(i)), t.push(this._getIntersection(t[1], V.set(1, .95, 0).applyMat4(i)))) : s[0] === 3 && (t[3] = this._getIntersection(t[2], U.set(.95, -1, 0).applyMat4(i)), t.push(this._getIntersection(t[0], V.set(-1, .95, 0).applyMat4(i))));
            else if (s.length === 2) s[0] === 0 && s[1] === 1 ? (t[0] = this._getIntersection(t[3], U.set(-1, -0.95, 0).applyMat4(i)), t[1] = this._getIntersection(t[2], V.set(1, -0.95, 0).applyMat4(i))) : s[0] === 1 && s[1] === 2 ? (t[1] = this._getIntersection(t[0], U.set(-0.95, 1, 0).applyMat4(i)), t[2] = this._getIntersection(t[3], V.set(-0.95, -1, 0).applyMat4(i))) : s[0] === 2 && s[1] === 3 ? (t[2] = this._getIntersection(t[1], U.set(1, .95, 0).applyMat4(i)), t[3] = this._getIntersection(t[0], V.set(-1, .95, 0).applyMat4(i))) : s[0] === 0 && s[1] === 3 && (t[0] = this._getIntersection(t[1], U.set(.95, 1, 0).applyMat4(i)), t[3] = this._getIntersection(t[2], V.set(.95, -1, 0).applyMat4(i)));
            else if (s.length === 3) {
                let r = 0;
                for(let a = 0; a < e.length; a++)s.includes(a) || (r = a);
                t = [
                    t[r]
                ], r === 0 ? (t.push(this._getIntersection(t[0], U.set(-0.95, 1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], V.set(-1, .95, 0).applyMat4(i)))) : r === 1 ? (t.push(this._getIntersection(t[0], U.set(.95, 1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], V.set(1, .95, 0).applyMat4(i)))) : r === 2 ? (t.push(this._getIntersection(t[0], U.set(.95, -1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], V.set(1, -0.95, 0).applyMat4(i)))) : r === 3 && (t.push(this._getIntersection(t[0], U.set(-0.95, -1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], V.set(-1.95, 0).applyMat4(i))));
        ...
        mouseToPlaneCoords(e) {
            if (_e.setAxisOrder(this.quaternion.axisOrder), _e.equals(this.quaternion) && ct.equals(this.transformOrigin)) return super.mouseToPlaneCoords(e);
            {
                ...
                }, s = this.camera.position.clone(), i = ut.set(t.x, t.y, -0.5);
                ...
                if (Math.abs(h) >= 1e-4) {
                    const o = this._matrices.world.matrix.getInverse().multiply(this.camera.viewMatrix), l = this._boundingRect.world.transformOrigin.clone().add(this._translation), d = pt.set(this._translation.x - l.x, this._translation.y - l.y, this._translation.z - l.z);
    ...
    class _t extends xe {
        constructor(e, t, { sampler: s = "uPingPongTexture", widthSegments: i, heightSegments: r, renderOrder: a, depthTest: h, cullFace: o, uniforms: l, vertexShaderID: d, fragmentShaderID: c, vertexShader: f, fragmentShader: u, texturesOptions: p, crossOrigin: m, alwaysDraw: w, visible: R, transparent: _, drawCheckMargins: x, autoloadSources: y, watchScroll: v, fov: P } = {}){
    ...
    const xt = (n, e, t, s, i)=>{
        ...
        if (e.fill.length > 1) {
            ...
            const o = Math.cos(r) * i.width, l = Math.sin(r) * i.height;
    ...
    const ve = ()=>{
        var n = new Date().getTime(), e = typeof performance < "u" && performance.now && performance.now() * 1e3 || 0;
    ...
    function yt(n) {
        const e = X(n.coords), t = n.getPositionOffset();
    ...
    function Z(n) {
        ...
        let t = n.states && [
            ...
            ...n.states.scroll,
            ...n.states.hover
        ].length, s = n.layerType === "effect" && (n.animating || n.type === "mouse");
        return e || s || t;
    }
    function bt(n, e, t) {
        const s = [];
    ...
    function vt(n, e) {
        ...
        ])[0] / e.offsetWidth, i = n.getPositionOffset(), r = document.createElement("div");
    ...
    function ce() {
        ...
        const n = b.scenes.filter((t)=>t.getAnimatingEffects().length), e = (t)=>{
    ...
    class Tt {
        ...
        updateEffect(e) {
            ...
            const s = performance.now(), i = e.uniforms[this.prop], r = Te(this.transition.ease), a = e.userData.createdAt + this.transition.delay, h = Math.max(0, Math.min(1, (s - a) / this.transition.duration));
            let o = this.value;
            if (h > 0 && h <= 1) {
                let l = r(h);
    ...
    class Rt {
        constructor({ prop: e, value: t, range: s, offset: i, momentum: r, uniformData: a, mode: h = "scrollIntoView", delta: o = .01, absScrollValue: l = !0 }){
            O(this, "type", "scroll");
        ...
        updateEffect(e, t, { top: s, height: i, isFixed: r }) {
            ...
            const a = typeof this.value == "object", h = e.uniforms[this.prop], o = window.innerHeight, l = window.scrollY || window.pageYOffset;
            if (r && (s -= l), this.mode === "scrollIntoView") {
                const d = s + l - o * this.offset, c = d + (o + i) * this.range;
                let f = (l - d) / (c - d), u = this.value;
                if (!h) return !1;
                let p = Math.max(0, Math.min(1, f));
                return this.lastTick !== void 0 && (p = Q(p, this.lastTick, this.momentum * 2)), this.lastTick !== void 0 && Math.abs(this.lastTick - p) < .001 ? !1 : (a ? (h.value.x = F(this.startVal.x, u.x, p), this.prop === "pos" ? h.value.y = F(1 - this.startVal.y, u.y, p) : h.value.y = F(this.startVal.y, u.y, p), this.startVal.type === "Vec3" && (h.value.z = F(this.startVal.z, u.z, p))) : h.value = F(this.startVal, u, p), this.lastTick = p, !0);
            } else if (this.mode === "whileScrolling") {
                const d = l - this.lastScrollTop;
                this.lastScrollTop = l;
                let c = d * this.delta, f = this.value;
                if (this.absScrollValue && (c = Math.abs(c)), this.lastTick !== void 0 && (c = Q(c, this.lastTick, this.momentum * 2), Math.abs(c) < .001)) return !1;
    ...
    class St {
        ...
        updateEffect(e, t, s) {
            ...
            let r = performance.now(), a, h = !1;
            s === null ? (h = !0, a = this.lastTick || r, this.lastProgress = this.rawProgress) : a = s + this.transition.delay;
            const o = e.uniforms[this.prop], l = Math.max(0, Math.min(1, (r - a) / this.transition.duration));
    ...
    function Mt(n) {
        return n.forEach((e)=>{
            var t, s;
            for(let i in e.props)((t = e.props[i]) == null ? void 0 : t.type) === "Vec2" ? e.props[i] = new L(e.props[i]._x, e.props[i]._y) : ((s = e.props[i]) == null ? void 0 : s.type) === "Vec3" ? e.props[i] = new T(e.props[i]._x, e.props[i]._y, e.props[i]._z) : typeof e.props[i] == "object" && (e.props[i] = B(e.props[i]));
        }), n;
    }
    class Re {
        constructor(e, t){
        ...
        setBreakpointValues() {
            const e = window.innerWidth, t = this.breakpoints.sort((r, a)=>a.min - r.min), s = {};
            ...
            for(let r in s)if (this.hasOwnProperty(r)) {
                let a = s[r];
    ...
    class Et extends ue {
        ...
        unpackage() {
            return this.fill = B(this.fill), this.stroke = B(this.stroke), this.coords = B(this.coords), this.coords.length && (!this.width || !this.height) && (this.width = [
                this.coords[0][0],
                this.coords[1][0]
            ], this.height = [
                this.coords[1][1],
                this.coords[2][1]
            ]), this.effects = B(this.effects), this.render(), this;
        }
        render() {
            let t;
            if (this.fitToCanvas) {
                ...
                ])[0] / s.element.offsetWidth, a = s.dpi * s.scale;
                let h = s.canvasWidth * r / a, o = s.canvasHeight * r / a;
                this.coords = [
                    [
                        0,
                        0
            ...
            if (this.local.ctx.beginPath(), this.type === "rectangle") {
                ...
                if (t.length) {
                    ...
                    if (!this.fitToCanvas) {
                        let o = this.coords[0][0] < this.coords[1][0], l = this.coords[0][1] > this.coords[2][1];
                        o && (h = [
                            -1,
                            -1,
                            -1,
                ...
                if (t.length >= 2) {
                    const i = X(t), r = X(this.coords), a = this.coords[0][1] > this.coords[2][1], h = i.center.y, o = i.center.x, l = (u, p, m, w, R)=>{
                        const _ = Math.cos(m), x = Math.sin(m);
                        u -= w, p -= R;
                        const y = u * _ - p * x, v = u * x + p * _;
                        return u = y + w, p = v + R, [
                            u,
                            p
                        ];
                    }, d = (this.rotation + (a ? .5 : 0)) * 2 * Math.PI, c = r.width / Math.sqrt(3) * .86, f = r.height / Math.sqrt(3) * .86;
                    this.local.ctx.beginPath();
                    for(let u = 0; u < s; u++){
                        const m = -Math.PI / 2 + 2 * Math.PI * u / s;
                        let w = o + c * Math.cos(m), R = h + f * Math.sin(m);
    ...
    class At extends ue {
        ...
        unpackage() {
            return this.effects = B(this.effects), this;
        }
        loadImage() {
            const t = new Image;
        ...
        renderImage() {
            const t = this.getPositionOffset(), s = this.state();
            let i = t.x, r = t.y;
            const a = this.rotation * 360 * (Math.PI / 180), h = this.getRelativeScale();
            let o = this.width * h * this.scaleX, l = this.height * h * this.scaleY;
            const d = s.dpi * s.scale;
            if (this.local.ctx.clearRect(0, 0, s.canvasWidth, s.canvasHeight), this.fitToCanvas) {
                const f = $([
                    s.element.offsetWidth,
                    s.element.offsetHeight
                ])[0] / s.element.offsetWidth;
                let u = this.width / this.height, p = s.canvasWidth * f / d, m = s.canvasHeight * f / d;
    ...
    class Ct extends ue {
        ...
        unpackage() {
            return this.fill = B(this.fill), this.highlight = B(this.highlight), this.coords = B(this.coords), this.effects = B(this.effects), this;
        }
        loadFont() {
            const t = this.fontFamily, s = this.fontStyle.includes("italic") ? "italic" : "normal", i = isNaN(parseInt(this.fontStyle)) ? 400 : parseInt(this.fontStyle);
        ...
        render() {
            ...
            const u = (_, x, y, v, P, S, D)=>{
                let C = x.split("").reduce((M, I, H)=>M + _.measureText(I).width + (H < x.length - 1 ? P : 0), 0), E;
                if (S === "center" ? E = y + (D - C) / 2 - D / 2 : E = y, S === "right") for(let M = x.length - 1; M >= 0; M--){
                    const I = x[M];
                    E -= _.measureText(I).width, _.fillText(I, E, v), M > 0 && (E -= P);
                }
                else for(let M = 0; M < x.length; M++)_.fillText(x[M], E, v), E += _.measureText(x[M]).width + P;
            }, p = (_, x)=>{
                let y = i + l * x + l / 2 + o / 3;
...
` && m.push(P);
    ...
    function Ce(n) {
        const e = b.scenes.filter((i)=>i.getAnimatingEffects().length), t = b.scenes.filter((i)=>i.rendering);
    ...
    function Ft() {
        b.scenes.forEach((n)=>{
            if (n.isInView && n.curtain.planes.find((e)=>e.uniforms.mousePos) && !(re() && n.interactivity && n.interactivity.mouse && n.interactivity.mouse.disableMobile)) {
                ...
                let e = n.isFixed ? n.element.offsetTop : n.bbox.top + n.scrollY, t = n.isFixed ? n.element.offsetLeft : n.bbox.left;
    ...
    class It {
        ...
        updateMouseTrail() {
            be && (this.mouse.trail.unshift([
                this.mouse.pos.x / (this.bbox.width * .5),
                1 - this.mouse.pos.y / (this.bbox.height * .5)
        ...
        getSplitOrderedItems() {
            ...
            if (s) {
                let i = s.parentLayer ? s.getParent() : null, r = i && Z(i), a = i && i.effects && i.effects.length && i.getChildEffectItems().filter((h)=>Z(h)).length;
        ...
        getPlaneParams(e, t) {
            ...
            if (e.isElement && (i.sampleBg = {
                ...
                i[d.prop] || (i[d.prop] = d.uniformData, i[d.prop].value = d.value);
            }), (h = e.data) != null && h.uniforms) for(let d in e.data.uniforms){
                let c = e.data.uniforms[d];
                i[d] = e.data.uniforms[d], ((o = c.value) == null ? void 0 : o.type) === "Vec3" ? i[d].value = new T(c.value._x, c.value._y, c.value._z) : ((l = c.value) == null ? void 0 : l.type) === "Vec2" ? i[d].value = new L(c.value._x, c.value._y) : typeof c.value == "object" && (i[d].value = B(c.value));
            }
        ...
        createPingPongPlane(e, t, s) {
            let i = this.getPlaneParams(e, 1), r = this.curtain.planes.find((a)=>a.type === "PingPongPlane" && a.userData.id === e.local.id);
        ...
        handleEffectPlane(e, t, s) {
            ...
            a && i.createTexture({
                ...
                e.texture,
                (h = e.data) == null ? void 0 : h.texture
            ].filter((o)=>o).forEach((o)=>{
                i.loadImage(o.src, {
                    sampler: o.sampler,
        ...
        handleElementPlane(e, t) {
            const s = e.getPlane(), i = e.getChildEffectItems(), r = this.layers.filter((l)=>!l.parentLayer);
        ...
        handleChildEffectPlane(e, t, s) {
            ...
            let a = this.getRenderTargets()[t - 1], h = this.curtain.planes.find((u)=>u.type === "PingPongPlane" && u.userData.id === e.local.id), o = r.effects.filter((u)=>{
            ...
            h && e.type === "mouse" && i.createTexture({
                ...
                e.texture,
                (f = e.data) == null ? void 0 : f.texture
        ...
        assignRenderTargetToPlane(e, t, s, i) {
            let r = this.getTextureParams(e, t, s), a = this.getRenderTargets()[t] || new le(this.curtain, r);
        ...
        setInitialEffectPlaneUniforms(e, t, s, i) {
            if (!e.userData.initialUniformsSet || !e.userData.isReady) {
                ...
                }), s && t.isMask && (t.mouseMomentum = s.mouseMomentum), e.userData.initialUniformsSet = !0;
            }
        }
        handleStateEffects(e, t) {
            if (this.isInView && !e.userData.createdAt && (e.userData.createdAt = performance.now()), !t.states || ![
                ...t.states.appear,
                ...t.states.scroll,
                ...t.states.hover
            ].length) return !1;
        ...
        setElementPlaneUniforms(e, t) {
            let s = this.element.offsetWidth * .5, i = this.element.offsetHeight * .5;
            if (e.uniforms.mousePos) {
                let r = this.mouse.pos.x, a = this.mouse.pos.y, h = r / s, o = 1 - a / i;
                if (t.mouseMomentum && t.type !== "mouse") {
                    t.local.lastMousePos || (t.local.lastMousePos = {
                        x: h,
                        y: o
                    });
                    let l = t.local.lastMousePos.x * s, d = (1 - t.local.lastMousePos.y) * i;
                    r = Q(r, l, t.mouseMomentum * 2), a = Q(a, d, t.mouseMomentum * 2), t.local.lastMousePos.x = r / s, t.local.lastMousePos.y = 1 - a / i;
                }
        ...
        setEffectPlaneUniforms(e, t) {
            ...
            let s = this.bbox.width / 2, i = this.bbox.height / 2;
            if (e.uniforms.mousePos) {
        ...
        getTextureParams(e, t, s) {
            var h;
            const r = e[t].userData.downSample ? .5 : 1, a = {
    ...
    function Ut(n, e, t, s, i) {
        ...
        if (t) {
            ...
            (i || e != null && e.includes("production=true")) && (a = "https://assets.unicorn.studio", e = `v=${Date.now()}`), r = `${a}/embeds/${n}${e ? "?" + e : ""}`;
        }
    ...
    function Vt() {
        ne || (ne = new IntersectionObserver((n)=>{
            n.forEach((e)=>{
                const t = e.target.getAttribute("data-scene-id"), s = b.scenes.find((i)=>i.id === t);
    ...
    function Ie(n) {
        ...
        return new Promise((s, i)=>{
            Ut(e, t, n.filePath, i, n.production).then((r)=>{
                ...
                const a = r.options || {}, h = zt(n.element) ? n.element : document.getElementById(n.elementId);
                if (!h) {
                ...
                const l = bt(r.history, o, Dt(h, n.scale || a.scale || 1, n.dpi || Math.min(1.5, window.devicePixelRatio))), d = new It({
                    id: o,
                    fps: n.fps || a.fps || 60,
                    dpi: n.dpi,
                    name: a.name,
                ...
                if (n.altText && (d.curtain.canvas.innerText = n.altText), n.ariaLabel && d.curtain.canvas.setAttribute("aria-label", n.ariaLabel), d.curtain.canvas.setAttribute("role", "image"), (a.freePlan || a.includeLogo) && wt(o, h), a.freePlan && console.log("Made with unicorn.studio"), b.scenes.push(d), d.layers = l, d.mouse.recordTrail = !!d.layers.find((c)=>c.type == "mouse"), d.setInteractiveParams(n, a), !d.lazyLoad) {
                    const c = d.bbox, f = c.top >= 0 && c.left >= 0 && c.bottom <= (window.innerHeight || document.documentElement.clientHeight) && c.right <= (window.innerWidth || document.documentElement.clientWidth);
    ...
    function Bt() {
        return new Promise((n, e)=>{
            ...
            [
                ...t
            ].filter((s)=>!s.getAttribute("data-us-initialized")).forEach((s, i)=>{
                const r = s.getAttribute("data-us-project"), a = s.getAttribute("data-us-project-src"), h = s.getAttribute("data-us-dpi"), o = s.getAttribute("data-us-scale"), l = s.getAttribute("data-us-lazyload"), d = s.getAttribute("data-us-production"), c = s.getAttribute("data-us-fps"), f = s.getAttribute("data-us-altText") || s.getAttribute("data-us-alttext"), u = s.getAttribute("data-us-ariaLabel") || s.getAttribute("data-us-arialabel"), p = s.getAttribute("data-us-disableMobile") || s.getAttribute("data-us-disablemobile");
    ...
    b.addScene = Ie, b.destroy = Ot, b.init = Bt, b.unbindEvents = kt, Object.defineProperty(b, Symbol.toStringTag, {
        value: "Module"
    });
});

},{}]},["hTuMO","csP6f"], "csP6f", "parcelRequire86c2")

//# sourceMappingURL=index.c33c63c0.js.map
