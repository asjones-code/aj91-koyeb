...
},{"process":"../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"js/terminal.js":[function(require,module,exports) {
"use strict";

var _typed = _interopRequireDefault(require("typed.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var $ = require("jquery");
var ws = new WebSocket("wss://asjones-cod-aj91-deno-69.deno.dev/");

// Cache DOM elements
var $prompt = $('.prompt');
var prephrase = '<span class="text-green-500">aj91.online</span> <span class="yellow"> (home)</span> <span class="red">#</span> ';
var commands = {
  clear: {
    cmd: 'clear',
    res: ''
...
var welcomeMessageTyped; // Store the Typed.js instance for later clearing

// Initialize Typed.js with welcome message (only once)
function initializeWelcomeMessage() {
  welcomeMessageTyped = new _typed.default('.prompt', {
...
function appendInputField() {
  ...
  var $userInput = $('#user-input'); // Cache the input field
  $userInput.focus();
...
function executeCommand(script) {
  var prompt = $('.prompt');
  var history = $('.history').html() || ''; // Cache current history
...
function handleUserInput(inputValue) {
  var normalizedInput = inputValue.trim().toLowerCase();
  if (normalizedInput in commands) {
    var command = commands[normalizedInput];

    // Prepare the script to run based on the command
    var script = {
      strings: [command.cmd],
      output: command.res ? "<div>".concat(prephrase).concat(command.res, "</div>") : '',
      postDelay: 1000,
      clear: normalizedInput === 'clear' ? true : false
    };
    if (normalizedInput === 'askai') {
      var userInput = ($('#user-input').val().split('askai')[1] || '').trim();
      ...
      fetch("https://api.arliai.com/v1/chat/completions", {
        ...
        var apiResponse = data.choices[0].message.content; // Adjust according to API response format
        script.next = {
          strings: [apiResponse],
          output: ''
        };
        ...
        script.next = {
          strings: ["API call failed: ".concat(error.message)],
          output: ''
        };
        executeCommand(script);
      });
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/terminal.js"], null)
//# sourceMappingURL=/terminal.319c4551.js.map