...
})({"8GAjV":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "75294b176ddd2e47";
"use strict";
...
},{}],"68Yh6":[function(require,module,exports) {
...
document.querySelector("h4").onmouseover = (event)=>{
    ...
    interval = setInterval(()=>{
        event.target.innerText = event.target.innerText.split("").map((letter, index)=>{
            if (index < iteration) return hoverText[index] || ""; // Change the inner text to the new hover text
...
document.querySelector("h4").onmouseleave = (event)=>{
    ...
    interval = setInterval(()=>{
        event.target.innerText = event.target.innerText.split("").map((letter, index)=>{
            if (index < iteration) return originalText[index] || ""; // Return to original text on mouse leave
            return letters[Math.floor(Math.random() * 26)];
        }).join("");
...
},{}]},["8GAjV","68Yh6"], "68Yh6", "parcelRequire86c2")

//# sourceMappingURL=index.6ddd2e47.js.map
