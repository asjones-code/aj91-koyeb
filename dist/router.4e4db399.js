...
},{"process":"../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/route-recognizer/dist/route-recognizer.es.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = RouteRecognizer;
},{}],"../node_modules/rsvp/dist/rsvp.es.js":[function(require,module,exports) {
var process = require("process");
"use strict";
...
exports.Promise = exports.EventTarget = void 0;
exports.all = all$1;
exports.allSettled = allSettled;
exports.asap = asap;
exports.cast = exports.async = void 0;
...
var cast = exports.cast = resolve$2;
...
var _default = exports.default = rsvp;
},{"process":"../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../node_modules/router_js/dist/modules/transition-aborted-error.js":[function(require,module,exports) {
"use strict";
...
function isTransitionAborted(maybeError) {
  return _typeof(maybeError) === 'object' && maybeError !== null && maybeError.code === 'TRANSITION_ABORTED';
}
function isAbortable(maybeAbortable) {
  return _typeof(maybeAbortable) === 'object' && maybeAbortable !== null && typeof maybeAbortable.isAborted === 'boolean';
}
...
},{}],"../node_modules/router_js/dist/modules/utils.js":[function(require,module,exports) {
"use strict";
...
function isQueryParamsContainer(obj) {
  if (obj && _typeof(obj) === 'object') {
    var cast = obj;
    return 'queryParams' in cast && Object.keys(cast.queryParams).every(function (k) {
...
},{}],"../node_modules/@glimmer/env/dist/modules/es2017/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.DEBUG = exports.CI = void 0;
const DEBUG = exports.DEBUG = false;
const CI = exports.CI = false;
},{}],"../node_modules/router_js/dist/modules/transition.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.STATE_SYMBOL = exports.REDIRECT_DESTINATION_SYMBOL = exports.QUERY_PARAMS_SYMBOL = exports.PARAMS_SYMBOL = void 0;
...
var REDIRECT_DESTINATION_SYMBOL = exports.REDIRECT_DESTINATION_SYMBOL = "__RDS__-2619863929824844-32323";
/**
  ...
  @private
 */
var Transition = exports.default = /*#__PURE__*/function () {
  ...
  _createClass(Transition, [{
    ...
    value: function followRedirects() {
      ...
      return this.promise.catch(function (reason) {
        if (_this2[REDIRECT_DESTINATION_SYMBOL]) {
          return _this2[REDIRECT_DESTINATION_SYMBOL].followRedirects();
        }
...
function isTransition(obj) {
  return _typeof(obj) === 'object' && obj instanceof Transition && obj.isTransition;
}
...
},{"rsvp":"../node_modules/rsvp/dist/rsvp.es.js","./transition-aborted-error":"../node_modules/router_js/dist/modules/transition-aborted-error.js","./utils":"../node_modules/router_js/dist/modules/utils.js","@glimmer/env":"../node_modules/@glimmer/env/dist/modules/es2017/index.js"}],"../node_modules/router_js/dist/modules/route-info.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.UnresolvedRouteInfoByParam = exports.UnresolvedRouteInfoByObject = exports.ResolvedRouteInfo = void 0;
...
function toReadOnlyRouteInfo(routeInfos) {
  ...
  var LOCAL_ROUTE_INFOS = new WeakMap();
  return routeInfos.map(function (info, i) {
    ...
    if (ROUTE_INFOS.has(key) && options.includeAttributes) {
      ...
      LOCAL_ROUTE_INFOS.set(key, _routeInfo);
      if (!options.localizeMapUpdates) {
        ROUTE_INFOS.set(key, routeInfoWithAttribute);
      }
      return routeInfoWithAttribute;
    }
    var routeInfosRef = options.localizeMapUpdates ? LOCAL_ROUTE_INFOS : ROUTE_INFOS;
    var routeInfo = {
      find: function find(predicate, thisArg) {
        ...
        if (predicate.length === 3) {
          ...
          // SAFETY: This should be safe since it is just for use as a key
          function (info) {
            return routeInfosRef.get(info);
          });
        }
        for (var _i = 0; routeInfos.length > _i; _i++) {
          // SAFETY: This should be safe since it is just for use as a key
          publicInfo = routeInfosRef.get(routeInfos[_i]);
...
var InternalRouteInfo = exports.default = /*#__PURE__*/function () {
  ...
  _createClass(InternalRouteInfo, [{
    ...
    key: "resolve",
    value: function resolve(transition) {
      var _this = this;
      return _rsvp.Promise.resolve(this.routePromise).then(function (route) {
        ...
        return (0, _transitionAbortedError.throwIfAborted)(transition);
      }).then(function () {
    ...
    key: "shouldSupersede",
    value: function shouldSupersede(routeInfo) {
...
var ResolvedRouteInfo = exports.ResolvedRouteInfo = /*#__PURE__*/function (_InternalRouteInfo) {
  ...
  function ResolvedRouteInfo(router, name, paramNames, params, route, context) {
    ...
    _this3 = _callSuper(this, ResolvedRouteInfo, [router, name, paramNames, route]);
...
var UnresolvedRouteInfoByParam = exports.UnresolvedRouteInfoByParam = /*#__PURE__*/function (_InternalRouteInfo2) {
  ...
  function UnresolvedRouteInfoByParam(router, name, paramNames, params, route) {
    ...
    _this4 = _callSuper(this, UnresolvedRouteInfoByParam, [router, name, paramNames, route]);
    _this4.params = {};
    if (params) {
...
var UnresolvedRouteInfoByObject = exports.UnresolvedRouteInfoByObject = /*#__PURE__*/function (_InternalRouteInfo3) {
  ...
  function UnresolvedRouteInfoByObject(router, name, paramNames, context) {
    ...
    _this5 = _callSuper(this, UnresolvedRouteInfoByObject, [router, name, paramNames]);
  ...
  _createClass(UnresolvedRouteInfoByObject, [{
    ...
    value: function getModel(transition) {
      ...
      return _get(_getPrototypeOf(UnresolvedRouteInfoByObject.prototype), "getModel", this).call(this, transition);
    }
    /**
      @private
...
},{"rsvp":"../node_modules/rsvp/dist/rsvp.es.js","./transition":"../node_modules/router_js/dist/modules/transition.js","./utils":"../node_modules/router_js/dist/modules/utils.js","./transition-aborted-error":"../node_modules/router_js/dist/modules/transition-aborted-error.js"}],"../node_modules/router_js/dist/modules/transition-intent.js":[function(require,module,exports) {
"use strict";
...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var TransitionIntent = exports.TransitionIntent = /*#__PURE__*/_createClass(function TransitionIntent(router) {
  var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  _classCallCheck(this, TransitionIntent);
  this.router = router;
  this.data = data;
});
},{}],"../node_modules/router_js/dist/modules/transition-state.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.TransitionError = void 0;
var _rsvp = require("rsvp");
var _utils = require("./utils");
var _transitionAbortedError = require("./transition-aborted-error");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var TransitionState = exports.default = /*#__PURE__*/function () {
  ...
  _createClass(TransitionState, [{
    ...
    value: function resolve(transition) {
      ...
      return _rsvp.Promise.resolve(null, this.promiseLabel('Start transition')).then(callback, null, this.promiseLabel('Resolve route')).catch(errorHandler, this.promiseLabel('Handle error')).then(function () {
        return _this;
      });
    }
  }]);
...
var TransitionError = exports.TransitionError = /*#__PURE__*/_createClass(function TransitionError(error, route, wasAborted, state) {
...
},{"rsvp":"../node_modules/rsvp/dist/rsvp.es.js","./utils":"../node_modules/router_js/dist/modules/utils.js","./transition-aborted-error":"../node_modules/router_js/dist/modules/transition-aborted-error.js"}],"../node_modules/router_js/dist/modules/transition-intent/named-transition-intent.js":[function(require,module,exports) {
"use strict";
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) _setPrototypeOf(subClass, superClass); }
function _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }
var NamedTransitionIntent = exports.default = /*#__PURE__*/function (_TransitionIntent) {
  ...
  function NamedTransitionIntent(router, name, pivotHandler) {
    ...
    _this = _callSuper(this, NamedTransitionIntent, [router, data]);
  ...
  _createClass(NamedTransitionIntent, [{
    ...
    value: function createParamHandlerInfo(name, names, objects, oldHandlerInfo) {
      ...
      if (missingParams.length > 0) {
        throw new Error("You didn't provide enough string/numeric parameters to satisfy all of the dynamic segments for route ".concat(name, ".") + " Missing params: ".concat(missingParams));
      }
...
},{"../route-info":"../node_modules/router_js/dist/modules/route-info.js","../transition-intent":"../node_modules/router_js/dist/modules/transition-intent.js","../transition-state":"../node_modules/router_js/dist/modules/transition-state.js","../utils":"../node_modules/router_js/dist/modules/utils.js"}],"../node_modules/router_js/dist/modules/unrecognized-url-error.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = UnrecognizedURLError;
},{}],"../node_modules/router_js/dist/modules/transition-intent/url-transition-intent.js":[function(require,module,exports) {
"use strict";
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); Object.defineProperty(subClass, "prototype", { writable: false }); if (superClass) _setPrototypeOf(subClass, superClass); }
function _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }
var URLTransitionIntent = exports.default = /*#__PURE__*/function (_TransitionIntent) {
  ...
  function URLTransitionIntent(router, url, data) {
    ...
    _this = _callSuper(this, URLTransitionIntent, [router, data]);
    _this.url = url;
    _this.preTransitionState = undefined;
    return _this;
  }
...
},{"../route-info":"../node_modules/router_js/dist/modules/route-info.js","../transition-intent":"../node_modules/router_js/dist/modules/transition-intent.js","../transition-state":"../node_modules/router_js/dist/modules/transition-state.js","../unrecognized-url-error":"../node_modules/router_js/dist/modules/unrecognized-url-error.js","../utils":"../node_modules/router_js/dist/modules/utils.js"}],"../node_modules/router_js/dist/modules/router.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Router, [{
    ...
    value: function queryParamsTransition(changelist, wasTransitioning, oldState, newState) {
      ...
      if (!wasTransitioning && this.activeTransition) {
        ...
        var newTransition = new _transition.default(this, undefined, undefined);
    ...
    value: function recognize(url) {
      var intent = new _urlTransitionIntent.default(this, url);
    ...
    value: function recognizeAndLoad(url) {
      ...
      var newState = this.generateNewState(intent);
      if (newState === null) {
        return _rsvp.Promise.reject("URL ".concat(url, " was not recognized"));
      }
      var newTransition = new _transition.default(this, intent, newState, undefined);
      return newTransition.then(function () {
        var routeInfosWithAttributes = (0, _routeInfo.toReadOnlyRouteInfo)(newState.routeInfos, newTransition[_transition.QUERY_PARAMS_SYMBOL], {
    ...
    value: function getTransitionByIntent(intent, isIntermediate) {
      ...
      if (isIntermediate) {
        var transition = new _transition.default(this, undefined, newState);
      ...
      newTransition = new _transition.default(this, intent, newState, undefined, this.activeTransition);
    ...
    */
    ...
    value: function doTransition(name) {
      ...
      if (name === undefined) {
        ...
        intent = new _namedTransitionIntent.default(this, name, undefined,
    ...
    */
    ...
    value: function refresh(pivotRoute) {
      ...
      var intent = new _namedTransitionIntent.default(this, name, pivotRoute, [], this._changedQueryParams || state.queryParams);
    ...
    */
    ...
    value: function generate(routeName) {
      ...
      var intent = new _namedTransitionIntent.default(this, routeName, undefined, suppliedParams);
    ...
    value: function applyIntent(routeName, contexts) {
      var intent = new _namedTransitionIntent.default(this, routeName, undefined, contexts);
    ...
    value: function isActiveIntent(routeName, contexts, queryParams, _state) {
      ...
      var intent = new _namedTransitionIntent.default(this, targetHandler, undefined, contexts);
    ...
    value: function isActive(routeName) {
      ...
      var _extractQueryParams = (0, _utils.extractQueryParams)(args),
        _extractQueryParams2 = _slicedToArray(_extractQueryParams, 2),
        contexts = _extractQueryParams2[0],
        queryParams = _extractQueryParams2[1];
...
},{"route-recognizer":"../node_modules/route-recognizer/dist/route-recognizer.es.js","rsvp":"../node_modules/rsvp/dist/rsvp.es.js","./route-info":"../node_modules/router_js/dist/modules/route-info.js","./transition":"../node_modules/router_js/dist/modules/transition.js","./transition-aborted-error":"../node_modules/router_js/dist/modules/transition-aborted-error.js","./transition-intent/named-transition-intent":"../node_modules/router_js/dist/modules/transition-intent/named-transition-intent.js","./transition-intent/url-transition-intent":"../node_modules/router_js/dist/modules/transition-intent/url-transition-intent.js","./transition-state":"../node_modules/router_js/dist/modules/transition-state.js","./utils":"../node_modules/router_js/dist/modules/utils.js"}],"../node_modules/router_js/dist/modules/index.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireWildcard(e, r) { if (!r && e && e.__esModule) return e; if (null === e || "object" != typeof e && "function" != typeof e) return { default: e }; var t = _getRequireWildcardCache(r); if (t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var u in e) if ("default" !== u && Object.prototype.hasOwnProperty.call(e, u)) { var i = a ? Object.getOwnPropertyDescriptor(e, u) : null; i && (i.get || i.set) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } return n.default = e, t && t.set(e, n), n; }
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./router":"../node_modules/router_js/dist/modules/router.js","./transition":"../node_modules/router_js/dist/modules/transition.js","./transition-state":"../node_modules/router_js/dist/modules/transition-state.js","./route-info":"../node_modules/router_js/dist/modules/route-info.js"}],"js/router.js":[function(require,module,exports) {
"use strict";

var _jquery = require("jquery");
var _router_js = _interopRequireDefault(require("router_js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var router = new _router_js.default();
function gql(_x) {
  return _gql.apply(this, arguments);
}
function _gql() {
  _gql = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(query) {
    var variables,
      data,
      _args = arguments;
...
var GET_USER_ARTICLES = "\nquery Publication{\n  publication(host: \"aj91.hashnode.dev\"){\n    isTeam\n    title   \n      posts(first: 10) {\n            edges {\n                node {\n                  id\n                  \tslug\n                    title\n                    brief\n                    url\n                    content{\n                    markdown\n                    }\n                }\n            }\n            totalDocuments\n        }\n    \n  \n  }\n}";
var showPost = "\nquery Publication{\n  publication(host: \"aj91.hashnode.dev\"){\n    isTeam\n    title   \n      posts(first: 10) {\n            edges {\n                node {\n                  id\n                  \tslug\n                    title\n                    url\n                    content{\n                    markdown\n                    }\n                }\n            }\n        }\n  }\n}";
gql(GET_USER_ARTICLES, {
  page: 0
}).then(function (result) {
  var article = result.data.publication.posts.edges[0].node;
  var title = result.data.publication.posts.edges[0].node.title;
  var url = result.data.publication.posts.edges[0].node.url;
  var slug = result.data.publication.posts.edges[0].node.slug;
  var md = result.data.publication.posts.edges[0].node.content.markdown;

  //console.log(article)
  console.log(slug);
  var pElement = document.querySelector("article p"); // Selects the <p> inside <article>
  var emElement = document.querySelector("article em"); // Selects the <p> inside <article>
  ...
  linkElement.addEventListener("click", function (event) {
    return route(event, url, title, slug, md);
  });
});
var route = function route(event, title, slug, md) {
  ...
  gql(showPost).then(function (postData) {
    history.pushState({}, slug, "blog/".concat(slug));

    // Render HTML in a specific container, e.g., #content
    console.log(postData.data.publication.posts.edges[0].node.content);
    var text = postData.data.publication.posts.edges[0].node.content;
    var contentContainer = document.getElementById('content');
    contentContainer.innerHTML = "\n                    <h1>".concat(title, "</h1>\n                    <p>").concat(JSON.stringify(text), "</p>\n                ");
  }).catch(function (error) {
    return console.error("Error fetching post data:");
  });
};
},{"jquery":"../node_modules/jquery/dist/jquery.js","router_js":"../node_modules/router_js/dist/modules/index.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
