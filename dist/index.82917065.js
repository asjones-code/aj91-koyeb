...
})({"e7Y2A":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "aa0e0bba82917065";
"use strict";
...
},{}],"b39wC":[function(require,module,exports) {
...
var typed = new (0, _typedJsDefault.default)(".typed", {
    strings: [
        "Loading...",
        "Thanks for stopping by. More updates coming soon - AJ"
    ],
    showCursor: false,
    typeSpeed: 30
});
(function app() {
    ...
    const view = {
        ...
        initTerminal () {
            ...
            if (this.$cli.length === 0) this.clearTerminal();
        ...
        typeChar (c) {
            ...
            if (realChr != "") {
                this.removeCursor();
                let p1 = this.$prompt.html();
                let pright = this.curPos == p1.length ? this.getCursor() : this.getCursor(p1.substring(this.curPos, this.curPos + 1)) + p1.substring(this.curPos + 1);
                this.$prompt.html(p1.substring(0, this.curPos) + realChr + pright);
        ...
        deleteChar () {
            if (this.curPos > 0) {
                this.removeCursor();
                let p1 = this.$prompt.html();
                this.$prompt.html(p1.substring(0, this.curPos - 1) + p1.substring(this.curPos));
                this.curPos = this.curPos - 1;
                this.setCursor();
            }
        },
        ...
        setCursor () {
            if (this.curPos >= 0) {
                this.removeCursor();
                let p1 = this.$prompt.html();
                this.$prompt.html(p1.substring(0, this.curPos) + (this.curPos == p1.length ? this.getCursor() : this.getCursor(p1.substring(this.curPos, this.curPos + 1))) + p1.substring(this.curPos + 1));
            } else if (p.length === 0) this.initCursor();
        },
        getCursor (char = "&nbsp;") {
        ...
        enterCommandLine () {
            let p1 = (0, _jqueryDefault.default).trim(this.$prompt.text());
            this.printTerminal(p1, "command label");
            controller.triggerCommand(p1);
            this.initCursor();
        },
        ...
        scrollPage (direction) {
            if (this.isScrolling === false) {
                ...
                let dh = this.$document.height(), wh = this.$window.height(), offset = this.$window.scrollTop() + wh * direction, adjusted = offset < 0 ? 0 : offset + wh > dh ? dh - wh : offset;
                view.$scroll.animate({
                    scrollTop: adjusted
    ...
    const controller = {
        ...
        getCommand (prompt = "") {
            ...
            return {
                ...
                "arguments": arrPrompt.filter((arg)=>{
                    return arg.length > 0;
                })
            };
        },
        ...
        encodeHtmlEntity (str) {
            var buf = [];
            for(var i = str.length - 1; i >= 0; i--)buf.unshift([
                "&#",
                str[i].charCodeAt(),
                ";"
            ].join(""));
...
},{"jquery":"hgMhh","typed.js":"6M0L2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6M0L2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["e7Y2A","b39wC"], "b39wC", "parcelRequire86c2")

//# sourceMappingURL=index.82917065.js.map
