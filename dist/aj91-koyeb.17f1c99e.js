...
})({"iBxEF":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "8b4f252317f1c99e";
"use strict";
...
},{}],"8SG7T":[function(require,module,exports,__globalThis) {
...
const revealActiveWords = ()=>{
    ...
    if (currentScrollPosition > containerEnd) activeWords = words.length;
    else if (currentScrollPosition < containerStart) activeWords = 0;
    else {
    ...
    if (availableToReveal) {
        for(var i = 0; i < words.length; i++)if (activeWords > i) words[i].style.opacity = 1;
        else words[i].style.opacity = 0.1;
    }
    if (currentScrollPosition > containerEnd || currentScrollPosition < containerStart) availableToReveal = false;
...
},{}]},["iBxEF","8SG7T"], "8SG7T", "parcelRequire86c2")

//# sourceMappingURL=aj91-koyeb.17f1c99e.js.map
