...
})({"i4f7D":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b22157f1bcfbda9c";
"use strict";
...
},{}],"gtU3Y":[function(require,module,exports,__globalThis) {
/**
...
function initHeroGlobe() {
    ...
    const camera = new _three.PerspectiveCamera(60, 1, 0.1, 100);
    camera.position.z = 5;
    ...
    const light = new _three.DirectionalLight(0xffffff, 1.2);
    light.position.set(5, 5, 5);
    scene.add(light);
    scene.add(new _three.AmbientLight(0xffffff, 0.4));
    ...
    const globe = new _three.Mesh(new _three.SphereGeometry(1.6, 128, 128), new _three.MeshStandardMaterial({
        map: earthMap,
        bumpMap: earthBump,
        bumpScale: 0.08,
    ...
    scene.add(globe);
    const atmosphere = new _three.Mesh(new _three.SphereGeometry(1.65, 128, 128), new _three.MeshBasicMaterial({
        color: 0x3399ff,
        transparent: true,
        opacity: 0.06
    }));
    ...
    function addLocationDot(lat, lng) {
        const dotGeometry = new _three.SphereGeometry(0.035, 16, 16);
        const dotMaterial = new _three.MeshBasicMaterial({
            color: 0xff6b00
        });
        const dot = new _three.Mesh(dotGeometry, dotMaterial);
        dot.position.copy(latLngToPosition(lat, lng));
        globe.add(dot);
    }
    if (navigator.geolocation) navigator.geolocation.getCurrentPosition((pos)=>addLocationDot(pos.coords.latitude, pos.coords.longitude), ()=>{}, {
        enableHighAccuracy: false,
        maximumAge: 60000,
        timeout: 5000
    });
    const composer = new (0, _effectComposerJs.EffectComposer)(renderer);
    composer.addPass(new (0, _renderPassJs.RenderPass)(scene, camera));
    const flyPass = new (0, _shaderPassJs.ShaderPass)(new _three.ShaderMaterial({
    ...
    const bloom = new (0, _unrealBloomPassJs.UnrealBloomPass)(new _three.Vector2(1, 1), 1.2, 0.4, 0.0);
...
},{"three":"dsoTF","three/examples/jsm/postprocessing/EffectComposer.js":"6j2Yd","three/examples/jsm/postprocessing/RenderPass.js":"jTJ5t","three/examples/jsm/postprocessing/UnrealBloomPass.js":"ecOVZ","three/examples/jsm/postprocessing/ShaderPass.js":"bnyMl"}],"6j2Yd":[function(require,module,exports,__globalThis) {
...
},{}],"bnyMl":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"three":"dsoTF","./Pass.js":"jQHYg","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"ecOVZ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"three":"dsoTF","./Pass.js":"jQHYg","../shaders/CopyShader.js":"3rJcg","../shaders/LuminosityHighPassShader.js":"7P1re","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7P1re":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"three":"dsoTF","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["i4f7D","gtU3Y"], "gtU3Y", "parcelRequire86c2")

//# sourceMappingURL=index_beta.bcfbda9c.js.map
